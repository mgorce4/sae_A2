...
<template>
    <div class="container-fluid main_div" style="align-items: center;">
        <div id="sub_div_for_MCCC_and_calender">
            <a class="button" @click="goToNext('/mccc-select-path', 'SuperAdmin')">MCCC</a>
            <a class="button" @click="goToNext('/admin-user', 'SuperAdmin')">Vue utilisateur</a>
            <a class="button" @click="goToNext('/add-institut-page', 'SuperAdmin')">Vue établissement</a>
        </div>
        ...
        <div id="return_sheets_div">
            ...
            <div id="list-of-resources">
                ...
                <div v-else v-for="sheet in getResourcesForSemester(selected_semester_sheets)" :key="sheet.id">
                    <div v-if="!sheet.hasTeacherHours" class="resource" style="background-color: var(--sub-scrollbar-color)">
                        <p class="resource_label">{{ sheet.resourceLabel }}</p>
                        <div style="gap: 5px">
                            <button class="btn1" style="width: 5vw" @click="goToResourceSheetDisplay('/resource-sheet-display', sheet.resourceLabel,)">
                                Visualiser
                            </button>
