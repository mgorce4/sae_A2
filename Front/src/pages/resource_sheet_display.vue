...
function is_linked_saes_defined() {
    return (
        resource_sheet.value.linkedSaes !== undefined && resource_sheet.value.linkedSaes.length > 0
    )
}
...
function is_modalities_defined() {
    return (
        resource_sheet.value.modalities !== undefined && resource_sheet.value.modalities.length > 0
    )
}

function is_hours_teacher_defined() {
    return (
        resource_sheet.value.hoursTeacher !== null &&
        resource_sheet.value.hoursTeacher !== undefined
    )
}
...
function is_hours_teacher_alternance_defined() {
    return (
        resource_sheet.value.hoursTeacherAlternance !== null &&
        resource_sheet.value.hoursTeacherAlternance !== undefined
    )
}

function is_hours_pn_alternance_defined() {
    return (
        resource_sheet.value.hoursPNAlternance !== null &&
        resource_sheet.value.hoursPNAlternance !== undefined
    )
}
    ...
    <div id="main">
        ...
        <div id="resource_sheet_display">
            <div class="header_Form">
                <p>Réf. UE :</p>
                <p v-if="ue_labels().length !== 0">
                    {{ ue_labels() && ue_labels().length > 0 ? ue_labels().join(', ') : '' }}
                </p>
            ...
            <div id="panel_NP">
                <div class="dark_bar" style="margin: 0">Objectif de la resource :</div>

                <div style="padding: 1.5vw">
                    <p v-if="is_objective_defined()" class="skill-input skill-input-description">
            ...
            <div id="panel_NP" style="justify-content: center">
                <div class="dark_bar" style="margin: 0">Compétences :</div>
                ...
                <div class="panel_NP">
                    <div class="skills_table" style="padding: 1.5vw">
                        ...
                        <div v-if="is_skills_defined()">
                            <div
                                v-for="skill in resource_sheet.skills"
                                :key="skill.id"
                                class="skill-row"
                            >
                                <div class="skill-inputs">
                                    <p class="skill-input skill-input-label">{{ skill.label }}</p>
                                    <p class="skill-input skill-input-description" rows="2">
                                        {{ skill.description }}
                                    </p>
                                </div>
                            </div>
            ...
            <div id="sae_alignement">
                ...
                <div v-if="is_linked_saes_defined()" class="sae_switches_container">
                    <div
                        v-for="sae in resource_sheet.linkedSaes"
                        :key="sae.id"
                        class="sae_switch_item"
                    >
                        <label class="switch">
            ...
            <div id="align_items_inline_center">
                <div id="align_items_column_left">
                    ...
                    <div v-if="is_keywords_defined()" class="keywords-container">
                        <div
                            v-for="keyword in resource_sheet.keywords"
                            :key="keyword"
                            class="keyword-item"
                        ...
                        >
                            <p
                                class="keyword-input"
                                style="margin-top: 0px; margin-bottom: 0px; flex: 0.5"
                            >
                                {{ keyword }}
                            </p>
                        </div>
                ...
                <div id="align_items_column_left">
                    ...
                    <div v-if="is_modalities_defined()" class="modalities-list">
                        <div
                            v-for="modality in resource_sheet.modalities"
                            :key="modality"
                            class="modality-item"
                        >
                    ...
                    <div class="hours_row">
                        <div class="hours_item">
                            ...
                            <div class="hours_box">
                                <p
                                    v-if="
                                        is_hours_teacher_defined() &&
                                        resource_sheet.hoursTeacher.cm !== undefined
                                    "
                                    class="hours_display"
                                    min="0"
                                    step="0.5"
                                >
                                    {{ resource_sheet.hoursTeacher.cm }}
                                </p>
                        ...
                        <div class="hours_item">
                            ...
                            <div class="hours_box">
                                <p
                                    v-if="
                                        is_hours_teacher_defined() &&
                                        resource_sheet.hoursTeacher.td !== undefined
                                    "
                                    class="hours_display"
                                    min="0"
                                    step="0.5"
                                >
                                    {{ resource_sheet.hoursTeacher.td }}
                                </p>
                                <p v-else class="hours_display" min="0" step="0.5">0</p>
                            </div>
                        </div>
                        <div class="hours_item">
                            ...
                            <div class="hours_box">
                                <p
                                    v-if="
                                        is_hours_teacher_defined() &&
                                        resource_sheet.hoursTeacher.tp !== undefined
                                    "
                                    class="hours_display"
                                    min="0"
                                    step="0.5"
                                >
                                    {{ resource_sheet.hoursTeacher.tp }}
                                </p>
                                <p v-else class="hours_display" min="0" step="0.5">0</p>
                            </div>
                        </div>
                        <div class="hours_total_display">
                            <p class="hours_total_text">
                                ...
                                <span
                                    v-if="
                                        is_hours_teacher_defined() &&
                                        resource_sheet.hoursTeacher.total !== undefined
                                    "
                                    class="hours_total_value"
                                    >{{ resource_sheet.hoursTeacher.total }}</span
                                >
                                <span v-else class="hours_total_value">0</span> /
                                <span
                                    v-if="
                                        is_hours_pn_defined() &&
                                        resource_sheet.hoursPN.total !== undefined
                                    "
                                    class="hours_total_value"
                                    >{{ resource_sheet.hoursPN.total }}</span
                                >
                                <span v-else class="hours_total_value">0</span>
                            </p>
                        </div>
                        ...
                        <div class="hours_row">
                            <div class="hours_item">
                                ...
                                <div class="hours_box">
                                    <p
                                        v-if="
                                            resource_sheet.hoursTeacherAlternance.cm !== undefined
                                        "
                                        class="hours_display"
                                        min="0"
                                        step="0.5"
                                    >
                                        {{ resource_sheet.hoursTeacherAlternance.cm }}
                                    </p>
                                    <p v-else class="hours_display" min="0" step="0.5">0</p>
                                </div>
                            </div>
                            <div class="hours_item">
                                ...
                                <div class="hours_box">
                                    <p
                                        v-if="
                                            resource_sheet.hoursTeacherAlternance.td !== undefined
                                        "
                                        class="hours_display"
                                        min="0"
                                        step="0.5"
                                    >
                                        {{ resource_sheet.hoursTeacherAlternance.td }}
                                    </p>
                                    <p v-else class="hours_display" min="0" step="0.5">0</p>
                                </div>
                            </div>
                            <div class="hours_item">
                                ...
                                <div class="hours_box">
                                    <p
                                        v-if="
                                            resource_sheet.hoursTeacherAlternance.tp !== undefined
                                        "
                                        class="hours_display"
                                        min="0"
                                        step="0.5"
                                    >
                                        {{ resource_sheet.hoursTeacherAlternance.tp }}
                                    </p>
                                    <p v-else class="hours_display" min="0" step="0.5">0</p>
                                </div>
                            </div>
                            <div class="hours_total_display">
                                <p class="hours_total_text">
                                    ...
                                    <span
                                        v-if="
                                            resource_sheet.hoursTeacherAlternance.total !==
                                            undefined
                                        "
                                        class="hours_total_value"
                                        >{{ resource_sheet.hoursTeacherAlternance.total }}</span
                                    >
                                    <span v-else class="hours_total_value">0</span> /
                                    <span
                                        v-if="
                                            is_hours_pn_alternance_defined() &&
                                            resource_sheet.hoursPNAlternance.total !== undefined
                                        "
                                        class="hours_total_value"
                                        >{{ resource_sheet.hoursPNAlternance.total }}</span
                                    >
                                    <span v-else class="hours_total_value">0</span>
                                </p>
                            </div>
                ...
                <div class="pedagogical-content">
                    <div class="pedagogical-section">
                        ...
                        <div class="pedagogical-items-container">
                            <div
                                v-if="!is_pedagogical_content_cm_defined()"
                            ...
                            <div v-else>
                                <div
                                    v-for="(item, index) in resource_sheet.pedagogicalContent.cm"
                                    :key="index"
                                    class="pedagogical-items"
                                >
                    ...
                    <div class="pedagogical-section">
                        ...
                        <div class="pedagogical-items-container">
                            <div
                                v-if="!is_pedagogical_content_td_defined()"
                                class="no-content-message"
                            >
                                Aucun contenu TD
                            </div>
                            <div v-else>
                                <div
                                    v-for="(item, index) in resource_sheet.pedagogicalContent.td"
                                    :key="index"
                                    class="pedagogical-items"
                                >
                                    <span class="pedagogical-number">{{ item.order }}</span>
                    ...
                    <div class="pedagogical-section">
                        ...
                        <div class="pedagogical-items-container">
                            <div
                                v-if="!is_pedagogical_content_tp_defined()"
                                class="no-content-message"
                            >
                                Aucun contenu TP
                            </div>
                            <div v-else>
                                <div
                                    v-for="(item, index) in resource_sheet.pedagogicalContent.tp"
                                    :key="index"
                                    class="pedagogical-items"
                                >
                                    <span class="pedagogical-number">{{ item.order }}</span>
                    ...
                    <div class="pedagogical-section">
                        ...
                        <div class="pedagogical-items-container">
                            <div
                                v-if="!is_pedagogical_content_ds_defined()"
                                class="no-content-message"
                            >
                                Aucun contenu DS
                            </div>
                            <div v-else>
                                <div
                                    v-for="(item, index) in resource_sheet.pedagogicalContent.ds"
                                    :key="index"
                                    class="pedagogical-items"
                                >
                                    <span class="pedagogical-number">{{ item.order }}</span>
            ...
            <div id="form">
                ...
                <div>
                    ...
                    <p
                        v-if="is_pedagogical_feedback_defined()"
                        id="text_area_styled"
                        class="tracking-textarea"
                    >
                        {{ resource_sheet.tracking.pedagogicalFeedback }}
                    </p>
                    <p v-else id="text_area_styled" class="tracking-textarea">
                        Aucun retour pédagogique
                    </p>
                    <p>Retour des étudiants</p>
                    <p
                        v-if="is_student_feedback_defined()"
                        id="text_area_styled"
                        class="tracking-textarea"
                    >
                        {{ resource_sheet.tracking.studentFeedback }}
                    </p>
                    <p v-else id="text_area_styled" class="tracking-textarea">
                        Aucun retour des étudiants
                    </p>
                    <p>Amélioration(s) à mettre en oeuvre</p>
                    <p
                        v-if="is_improvement_suggestions_defined()"
                        id="text_area_styled"
                        class="tracking-textarea"
                    >
                        {{ resource_sheet.tracking.improvementSuggestions }}
                    </p>
                    <p v-else id="text_area_styled" class="tracking-textarea">
                        Aucun retour pédagogique
                    </p>
